...
function HandleSubmition(e) {
    ...
    fetch(`https://adeccollc-backend.vercel.app/api/airmax/apply/job/?first_name=${first_name}&last_name=${last_name}&zipcode=${zipcode}&email=${email}&address=${address}&phone=${phone}&age=${age}&nearest_nike=${nearest_nike}&nearest_walmart=${nearest_walmart}`)
